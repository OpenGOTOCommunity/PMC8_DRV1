                ...
                If Not AtPark Then
                    ...
                    If RATracking Then
                        ...
                        Select Case Direction
                            Case 0 'North                             
                                DECNewRate = (DEC_SiderealRateFraction / 100) * (MountDECCounts / 86400)
                                'first set direction
                            ...
                            Case 1 'South
                                ...
                                SerMutex.ReleaseMutex()
                            Case 2 'East
                                'RANewRate = (MountRACounts / 86400) - ((RA_SiderealRateFraction / 100) * (MountRACounts / 86400))
                                RANewRate = (MountRACounts / 3456) - ((RA_SiderealRateFraction / 100) * (MountRACounts / 3456))
